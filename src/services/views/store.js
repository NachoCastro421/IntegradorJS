...
//encargada de filtrar y renderizar la seccion con todos sus elementos
export const handleRenderList = (productosIn) => {
    ...
    const renderProductGroup = (productos, title) => {
        if (productos.length > 0) {
            ...
            //return de la seccion con todos los elementos dentro
            return `
    ...
    `;
    //se agregan los eventos de manera dinamica
